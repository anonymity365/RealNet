...
cv2.imwrite(f'img/im_noisy.png', cv2.cvtColor(im_noisy, cv2.COLOR_RGB2BGR))
cv2.imwrite(f'img/im_gt.png', cv2.cvtColor(im_gt, cv2.COLOR_RGB2BGR))
cv2.imwrite(f'img/im_denoise.png', cv2.cvtColor(im_denoise, cv2.COLOR_RGB2BGR))
# plt.subplot(1,3,1)
# plt.imshow(im_noisy)
